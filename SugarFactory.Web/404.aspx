...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="SugarFactory.Web.Views.Shared.WebForm1" %>
...
<body style="background-color: #63458f">
   ...
   <div class="row bg">
    <div class="col-md-4 col-lg-offset-2">
        <h2 style="color: white">Ooops, <br />you just entered in the land of Unicorns! Forest number <span class="text-warning">404</span>.</h2>
