...
using SugarFactory.Data.Migrations;
...
namespace SugarFactory.Data
{
    ...
    public class SugarFactoryContext : IdentityDbContext<ApplicationUser>
    {
        public SugarFactoryContext()
            : base("SugarFactoryContext")
        { //"data source=.;initial catalog=SugarFactoryDb;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework", throwIfV1Schema: false
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<SugarFactoryContext, Configuration>());
        }
